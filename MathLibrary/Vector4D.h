 ...
 * @param _w Value for w | Default = 0
 */
		 ...
		 */
		Vector4D(const Vector4D& _otherVector)
		{
			x = _otherVector.x;
			y = _otherVector.y;
			z = _otherVector.z;
		 ...
		 */
		static float Dot(const Vector4D& _firstVector, const Vector4D& _secondVector)
		{
		 ...
		 */
		Vector4D Cross(const Vector4D& _otherVector) const
		{
			Vector4D tempVector = *this;
		 ...
		 */
		static Vector4D Cross(const Vector4D& _firstVector, const Vector4D& _secondVector)
		{
		...
		/*
		 * Returns the Absolute Values for the Vector4D
		 *
		 ...
		 */
		float Distance(const Vector4D& _otherVector) const
		{
		 ...
		 */
		float DistanceSqr(const Vector4D& _otherVector) const
		{
		 ...
		 * @return The distance between those points.
		 */
		static float Distance(const Vector4D& _firstVector, const Vector4D& _secondVector)
		{
		 ...
		 * @return The distance between those points.
		 */
		static float DistanceSqr(const Vector4D& _firstVector, const Vector4D& _secondVector)
		{
		 ...
		 */
		float AngleBetween(const Vector4D& _otherVector) const
		{
		 ...
		 */
		Vector4D operator +(const Vector4D& _otherVector) const
		{
			Vector4D temp = *this;
		 ...
		 */
		Vector4D operator *(float _otherFloat) const
		{
			Vector4D temp = *this;
			temp.x *= _otherFloat;
			temp.y *= _otherFloat;
		 ...
		 */
		Vector4D& operator *=(float _otherFloat)
		{
			x *= _otherFloat;
			y *= _otherFloat;
			z *= _otherFloat;
		 ...
		 */
		bool operator == (const Vector4D& _otherVector) const
		{
	 ...
	 * @return The scaled Vector.
	 */
	inline Vector4D operator*(float _scalar, const Vector4D& _vector)
	{
